from PunyaAlby import CMD_LIST, XTRA_CMD_LIST, pyrotgbot as bot
from PunyaAlby._func.decorators import Config, alby_cmd as fkm_on_cmd
from PunyaAlby._func._helpers import edit_or_reply, get_text
...
def prepare_cmd_list():
    main_l = f"<b><u> __ALBY PYROBOT CommandList__ </b></u> \n\n<b> __Number CommandList__ ({len(CMD_HELP)}) :</b> \n\n"
    for i in CMD_HELP:
        if i:
