...
from main_startup.helper_func.basic_helpers import get_all_pros
from pyrogram import filters
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup
from WhyzuProjects import bot

from config import *
from database.bot_users import add_user, check_user, get_all_users
from PunyaAlby.helper_func.assistant_helpers import _check_admin, _check_owner_or_sudos
from PunyaAlby.helper_func.basic_helpers import get_readable_time
from WhyzuProject import start_time
    ...
    if user_id not in all_user_s:
        ...
        await client.send_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Help Me ❓", url="t.me/ruangdiskusikami")]]
            ),
        )
    else:
