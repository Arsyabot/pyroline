...
class Var(object):
    ...
    STRING_SESSION = os.environ.get("SESSION", None)
    STRING_SESSION = (
        sys.argv[3] if len(sys.argv) > 3 else os.environ.get("SESSION", None)
    )
...
class Database(object):
    ...
    DB_URIl = os.environ.get(
        "DATABASES_URL",
        "mongodb+srv://petercord:b38DJZL3X6zhnHJ0@cluster0.e9xau.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
    )
...
class Osdb(object):
    ...
    UPSTREAM_REPO_URL = os.environ.get(
        "UPSTREAM_REPO_URL", "https://github.com/PunyaAlby/pyroline.git"
    )
...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/PunyaAlby/pyroline.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "albyuserbot")
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/7b2a3fa167686dfaa3da8.jpg"
    )
    ALBY_HELP_LOGO = os.environ.get("ALBY_HELP_LOGO", None)
    UB_BLACK_LIST_CHAT = {
    ...
    COMMAND_HAND_LER = SqL.getdb("COMMAND_HAND_LER") or os.environ.get(
        "COMMAND_HAND_LER", r"."
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/PunyaAlby/pyroline"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph/file/7b2a3fa167686dfaa3da8.jpg"
    )
    U_BRANCH = "main"
    ...
    ENABLE_WAIFU_FOR_ALL_CHATS = bool(
        strtobool(str(os.environ.get("ENABLE_WAIFU_FOR_ALL_CHATS", False)))
    )
    ...
    LOAD_UNOFFICIAL_PLUGINS = bool(
        strtobool(str(os.environ.get("LOAD_UNOFFICIAL_PLUGINS", True)))
    )
